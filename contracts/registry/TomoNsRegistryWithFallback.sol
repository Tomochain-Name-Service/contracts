...
import "./TomoNs.sol";
import "./TomoNsRegistry.sol";

/**
 * The TomoNs registry contract.
 */
contract TomoNsRegistryWithFallback is TomoNsRegistry {
    TomoNs public old;

    /**
     * @dev Constructs a new Tomo registrar.
     */
    constructor(TomoNs _old) public TomoNsRegistry() {
        old = _old;
    }
